...
func TestCompressEncodesDictionarySizeToOutput(t *testing.T) {
	input := vector.New()
...
func TestDecompressReturnsErrorOnBadlyCompressedData(t *testing.T) {
	input := vector.New().AppendToCopy(uint16(XL), uint16(3121))
